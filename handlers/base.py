...
async def cmd_help(message: Message):
    ...
    help_text = format_message_with_username(
        "🎮 <b>Tehnolog Games</b> — игры на коины, экономика, профиль с лигой и достижениями\n\n",
        username, first_name
    )
    ...
    help_text += "🛑 /cancel — отмена текущей игры (kripta, almaz и др.) | /status — есть ли у тебя активная игра\n\n"
